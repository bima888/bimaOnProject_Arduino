...
float mannormal = 7.06 ;
float manipulasi2 = 4.98 ;
float manipulasi3 = 4.33 ;
float manipulasi4 = 4.08 ;
float manipulasi4 = 3.69 ;
float manipulasi4 = 3.48 ;
...
void parsing(){
  ...
  Firebase.pushFloat("PH/data",phValue);
  Firebase.setFloat("PH/latest",phValue);
}
