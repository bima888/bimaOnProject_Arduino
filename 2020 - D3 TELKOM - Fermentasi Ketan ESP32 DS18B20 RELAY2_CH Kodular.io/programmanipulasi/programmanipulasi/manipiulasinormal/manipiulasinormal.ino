...
void loop() {
  ...
  {   
    ...
    if (manipulasinormal >= 4.0 || manipulasinormal == 4.0)
    {Firebase.setString("kondisi/ph", "FermentasiSelesai");}
    if (manipulasinormal <= 4.0)
...
void parsing(){
  ...
  Firebase.pushFloat("PH/data",manipulasinormal);
  Firebase.setFloat("PH/latest",manipulasinormal);
}
