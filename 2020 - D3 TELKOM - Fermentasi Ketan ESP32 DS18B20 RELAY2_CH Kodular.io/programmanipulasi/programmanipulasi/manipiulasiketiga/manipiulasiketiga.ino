...
void loop() {
  ...
  {   
    ...
    if (manipulasiketiga >= 4.0 || manipulasiketiga == 4.0)
    {Firebase.setString("kondisi/ph", "FermentasiSelesai");}
    if (manipulasiketiga <= 4.0)
...
void parsing(){
  ...
  Firebase.pushFloat("PH/data",manipulasiketiga);
  Firebase.setFloat("PH/latest",manipulasiketiga);
}
