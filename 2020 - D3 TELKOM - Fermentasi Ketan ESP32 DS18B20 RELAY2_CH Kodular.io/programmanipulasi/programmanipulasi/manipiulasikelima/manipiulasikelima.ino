...
void loop() {
  ...
  {   
    ...
    if (manipulasikelima >= 4.0 || manipulasikelima == 4.0)
    {Firebase.setString("kondisi/ph", "FermentasiSelesai");}
    if (manipulasikelima <= 4.0)
...
void parsing(){
  ...
  Firebase.pushFloat("PH/data",manipulasikelima);
  Firebase.setFloat("PH/latest",manipulasikelima);
}
