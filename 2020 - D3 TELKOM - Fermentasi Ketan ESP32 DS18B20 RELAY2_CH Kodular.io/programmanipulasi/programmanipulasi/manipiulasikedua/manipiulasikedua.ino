...
void loop() {
  ...
  {   
    ...
    if (manipulasikedua >= 4.0 || manipulasikedua == 4.0)
    {Firebase.setString("kondisi/ph", "FermentasiSelesai");}
    if (manipulasikedua <= 4.0)
...
void parsing(){
  ...
  Firebase.pushFloat("PH/data",manipulasikedua);
  Firebase.setFloat("PH/latest",manipulasikedua);
}
